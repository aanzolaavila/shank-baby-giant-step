...
public class Main {
	...
	final static int PRIME_UNCERTAINTY = 100000;
	...
	public static void main(String[] args) {
		...
		if (fromStdin) {
			...
			if (!isSafePrime(p)) {
				System.err.println("p:" + p + " is not SAFE prime");
				return;
			}
			...
			System.out.print("Generating SAFE prime ");
			do {
...
//		System.out.println(extendedEuclid(BigInteger.valueOf(55), BigInteger.valueOf(11)));
	...
	static public boolean isSafePrime(BigInteger p) {
		// Check if p is safe prime
		if (!p.isProbablePrime(PRIME_UNCERTAINTY)) {
			System.err.println("p:" + p + " is not prime");
			return false;
		}
